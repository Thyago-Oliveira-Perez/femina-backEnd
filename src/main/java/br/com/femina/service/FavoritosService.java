...
import br.com.femina.repository.FavoritosRepository;
...
public class FavoritosService {
    ...
    public Page<Favoritos> findAll(Pageable pageable) {return this.favoritosRepository.findAllByHabilitado(true, pageable);}
